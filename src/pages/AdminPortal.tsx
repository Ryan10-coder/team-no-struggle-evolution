...
const AdminPortal = () => {
  ...
  const exportPaymentsPDF = () => {
    ...
    filteredContributions.forEach((c, i) => {
      doc.text(`${c.member_id || c.member_name} - ${c.amount} - ${c.contribution_date}`, 10, 20 + i * 8);
    });
  ...
  const filteredExpenditures = monthFilter
    ...
    : monthlyExpenses;
, setMonthlyExpenses] = useState<MonthlyExpense[]>([]);
            ...
            <div className="grid gap-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Filter contributions by date and export (PDF / Excel)</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                ...
                <CardContent>
                  <form onSubmit={handleDisbursementSubmit} className="space-y-2">
                    <Input placeholder="Beneficiary (name or member id)" value={beneficiary} onChange={(e) => setBeneficiary(e.target.value)} required />
                  ...
                  <Table className="mt-4">
                    ...
                    <TableBody>
                      {disbursements.map(d => (
                        <TableRow key={d.id}>
                          <TableCell>{d.beneficiary || d.member_id}</TableCell>
